...
public class CreateBicBitModTabs {
	public static final CreativeModeTab CREATIVE_TAB = new CreativeModeTab("cbb_creative_tab") {
		...
		public void fillItemList(NonNullList<ItemStack> items) {
			...
			items.add(new ItemStack(CreateBicBitModItems.RAW_CHEESE_SOUFFLE.get()));
			items.add(new ItemStack(CreateBicBitModItems.CHEESE_SOUFFLE.get()));
			...
			items.add(new ItemStack(CreateBicBitModItems.RAW_EGGBALL.get()));
			items.add(new ItemStack(CreateBicBitModItems.EGGBALL.get()));
			...
			items.add(new ItemStack(CreateBicBitModItems.COATED_CHURROS.get()));
			items.add(new ItemStack(CreateBicBitModItems.WRAPPED_COATED_CHURROS.get()));
			...
			items.add(new ItemStack(CreateBicBitModItems.CURDLED_MILK_BUCKET.get()));
			...
			items.add(new ItemStack(CreateBicBitModItems.UNRIPE_CHEESE_WEDGE.get()));
			items.add(new ItemStack(CreateBicBitModItems.YOUNG_CHEESE_WEDGE.get()));
			items.add(new ItemStack(CreateBicBitModItems.AGED_CHEESE_WEDGE.get()));
			items.add(new ItemStack(CreateBicBitModItems.CRUSHED_NETHERWART.get()));
			items.add(new ItemStack(CreateBicBitModItems.KETCHUP_BOTTLE.get()));
			items.add(new ItemStack(CreateBicBitModItems.MAYONNAISE_BOTTLE.get()));
			...
			items.add(new ItemStack(CreateBicBitModItems.FRYING_OIL_BOTTLE.get()));
