...
public class FluidsRegistry {
    ...
    private void applyOilEffect(Player player) {
        MobEffectInstance oiledup = new MobEffectInstance(ModEffects.OILED_UP.get(), 200, 0);
        player.addEffect(oiledup);
    }
